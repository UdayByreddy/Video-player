        ...
        <div className="px-4 py-4">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-dark-800 border border-dark-700 rounded-xl px-4 py-3 text-black placeholder-gray-500 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all"
            />
            <svg
              aria-hidden="true"
